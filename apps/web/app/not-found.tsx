...
const NotFoundPage = () => {
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-3xl flex-col items-center justify-center px-6 text-center">
      ...
      <Link
        href="/"
        className="mt-6 inline-flex rounded-full border border-emerald-700 bg-emerald-700 px-4 py-2 text-sm font-semibold text-white transition hover:bg-emerald-800 dark:border-teal-300 dark:bg-teal-300 dark:text-slate-950 dark:hover:bg-teal-200"
      >
        Tagasi avalehele
      </Link>
    </main>
